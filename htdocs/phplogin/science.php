...
<h1 style="text-align:center;color:#000;padding-top:200px;font-weight:bold;">Science</h1>
...
<h1 style="margin-top:105px;font-weight:100;" class="o">Science worksheets</h1>
<a href="<?php If($grade == "3")
{
...
?> " style="text-decoration:none;color:blue;" class="who"><?php If($grade == "3")
{
...
?>" style="text-decoration:none;color:blue;margin-top:500px;" class="who"><?php If($grade == "3")
{
