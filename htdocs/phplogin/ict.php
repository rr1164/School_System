...
<div class="ho" style="width:100%;height:400px;background-image:url(https://www.eurodiaconia.org/wordpress/wp-content/uploads/2018/03/Digitalisation_ICT_network.jpg);background-position:center;background-size: cover;">
<h1 style="text-align:center;color:#fff;padding-top:160px;font-weight:bold;font-size:70px;">ICT</h1>
...
<h1 style="margin-top:105px;font-weight:100;" class="o">ICT worksheets</h1>
<a href="<?php 
...
?>" style="text-decoration:none;color:blue;margin-top:100px;" class="who"><?php
