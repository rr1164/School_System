...
<div class="ho" style="width:100%;height:400px;background-image:url(http://testfff.epizy.com/photos/e.jpg);background-position:center;background-size: cover;">
<h1 style="text-align:center;color:#000;padding-top:160px;font-weight:bold;font-size:70px;">ISLAMIC</h1>
...
<h1 style="margin-top:105px;font-weight:100;" class="o">ISLAMIC worksheets</h1>
<a href="<?php 
 If($grade == "2")
{
