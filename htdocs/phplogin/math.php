...
<div class="nope6"><a  href="islamic.php" style="cursor:pointer;color:white;font-size:18px;position:absolute;font-weight:bold;font-family:'Rubik'" class="hover7"><?php 
...
<a href=""><h1 style="font-size:18px;text-align:center;margin-top:80px;color:white;font-family:'Rubik'">Home</h1></a>
<a href=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">About Us</h1></a>
<a href=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">School location</h1></a>
<a href=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">Almajd Staff</h1></a>
<a href=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">Contact Form</h1></a>
<a href=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">Contact Emails</h1></a>
<a href="" style=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">Gallery</h1></a>
<a href="" style=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">Oflline Survey</h1></a>
<a href="" style=""><h1 style="font-size:18px;margin-top:20px;color:white;text-align:center;font-family:'Rubik'">Recruitments</h1></a>
</ul>
</div>
</header>
<div class="ho" style="width:100%;height:400px;background-image:url(https://www.immerse.education/wp-content/uploads/math_bg.jpg);background-position:center;background-size: cover;">
<h1 style="text-align:center;color:#fff;padding-top:160px;font-weight:bold;font-size:70px;">MATH</h1>
<div style="position: absolute;left: 0;right: 0;margin: auto;width: 65px;height: 2px;background: #fff;"></div>
</div>
...
<h1 style="margin-top:105px;font-weight:100;" class="o">MATH worksheets</h1>
<a href="<?php 
 If($grade == "2")
{
...
?> " style="text-decoration:none;color:blue;" class="who"><?php 
If($grade == "1")
{
Echo "grade 1 first worksheet first term " ;
}

If($grade == "2")
{
Echo "grade 2 first worksheet first term " ;
}

If($grade == "3")
{
Echo "grade 3 first worksheet first term " ;
}

If($grade == "4")
{
Echo "grade 4 first worksheet first term " ;
}

If($grade == "5")
{
Echo "grade 5 first worksheet first term " ;
}

If($grade == "6")
{
Echo "grade 6 first worksheet first term " ;
}

If($grade == "7")
{
Echo "grade 7 first worksheet first term " ;
}
...
?>" style="text-decoration:none;color:blue;margin-top:500px;" class="who"><?php 
If($grade == "1")
{
Echo " grade 1 second worksheet first term " ;
}If($grade == "2")
{
Echo " grade 2 second worksheet first term " ;
}
If($grade == "3")
{
Echo " grade 3 second worksheet first term " ;
}
If($grade == "4")
{
Echo "grade 4 second worksheet first term " ;
}
If($grade == "5")
{
Echo "grade 5 second worksheet first term " ;
}
If($grade == "6")
{
Echo "grade 6 second worksheet first term " ;
}
If($grade == "7")
{
Echo "grade 7 second worksheet first term " ;
}
